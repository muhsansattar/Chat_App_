...
## Chat Room
![Screenshot 2024-09-27 183817](https://github.com/user-attachments/assets/bb0489f2-40c4-4b10-99fc-fd7b1adde2c9)
## Login
...
- User Authentication: Secure registration and login processes for users.
- Group Chats: Create and manage group conversations easily.
- Responsive Design: Optimized for both desktop and mobile devices.
- Emoji Support: Add expressiveness to messages with emoji integration.
...
- Express: A web application framework for building APIs and handling routes.
- Socket.io: Enables real-time, bidirectional communication between clients and servers.
- PostgreSQL: A powerful relational database for storing user data and chat messages.
